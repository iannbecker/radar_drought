...
# This script is used to make the supplemental GAM response curves (Figures S2-S3)
...
# Load preprocessing info (has original stats before standardization)
